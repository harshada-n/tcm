...
enum Right: string
{
    ...
    case ROLE_RIGHT_TRANSACTION_READ = 'ROLE_RIGHT_TRANSACTION_READ';
    case ROLE_RIGHT_TRANSACTION_CREATE = 'ROLE_RIGHT_TRANSACTION_CREATE';
    case ROLE_RIGHT_TRANSACTION_DELETE = 'ROLE_RIGHT_TRANSACTION_DELETE';
    case ROLE_RIGHT_TRANSACTION_UPDATE = 'ROLE_RIGHT_TRANSACTION_UPDATE';
}
